...
########################################################################
# generator.sh for VHDL task Cache
...
# edited: 2018, HAUER Daniel, daniel.hauer@tuwien.ac.at
########################################################################
...
cp ${task_path}/static/cache_beh.vhdl ${desc_path}
mv ${task_path}/tmp/cache_${user_id}_Task${task_nr}.vhdl ${desc_path}/cache.vhdl
...
##########################
task_attachments=""
task_attachments_base="${desc_path}/desc_${user_id}_Task${task_nr}.pdf ${desc_path}/cache_beh.vhdl ${desc_path}/cache.vhdl"
