...
mv $task_path/tmp/counter_$1_Task$2.vhdl $desc_path/counter.vhdl

##########################
##   EMAIL ATTACHMENTS  ##
##########################
task_attachments="$desc_path/desc_$1_Task$2.pdf $desc_path/counter.vhdl $desc_path/counter_beh.vhdl"
