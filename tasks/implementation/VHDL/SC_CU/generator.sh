...
cp ${task_path}/static/SC_CU.vhdl ${desc_path}
cp ${task_path}/static/SC_CU_beh.vhdl ${desc_path}

#for exam
#cp ${task_path}/exam/testbench_exam.vhdl ${desc_path}/SC_CU_tb_exam.vhdl
...
##########################
task_attachments=""
task_attachments_base="${desc_path}/desc_${user_id}_Task${task_nr}.pdf ${desc_path}/SC_CU.vhdl ${desc_path}/SC_CU_beh.vhdl"

# if [ -n "${mode}" ];
# then
#     if [ "${mode}" = "exam" ];
#     then
#         task_attachments="$task_attachments_base ${desc_path}/SC_CU_tb_exam.vhdl"
#     fi
# fi
