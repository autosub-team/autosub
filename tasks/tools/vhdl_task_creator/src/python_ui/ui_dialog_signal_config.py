...
class Ui_DialogSignalConfig(object):
    def setupUi(self, DialogSignalConfig):
        ...
        self.label_infolabel = QtWidgets.QLabel(DialogSignalConfig)
        self.label_infolabel.setEnabled(True)
        self.label_infolabel.setObjectName("label_infolabel")
        self.gridLayout.addWidget(self.label_infolabel, 4, 6, 1, 1)
    ...
    def retranslateUi(self, DialogSignalConfig):
        ...
        self.label_infolabel.setText(_translate("DialogSignalConfig", "Use {{ ... }} as  delimiters"))
