...
class Ui_PageTaskOverall(object):
    def setupUi(self, PageTaskOverall):
        ...
        PageTaskOverall.resize(494, 300)
        ...
        self.label = QtWidgets.QLabel(PageTaskOverall)
        ...
        self.gridLayout.addWidget(self.timeout, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkbox_attach_wavefile, 8, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.checkbox_constraint_script, 9, 1, 1, 2)
