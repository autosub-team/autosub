...
\begin{enumerate}
    ...
    \item After a maximum of %%CLOCKCYCLES clock cycles of the clock at port CLK the calculated CRC has to be set at port CRC and the port CRC\_VALID has to be set to 1 to indicate a valid calculation result.
\end{enumerate}
