...
It has an input which is address, a clock cycle and enable signal. The length of address is %%ADDRLENGTH bits and the length of instruction is %%INSTRUCTIONLENGTH which is in the same size as the output. The ROM works on %%CLK of clock cycle. \\
