...
ghdl -a fsm_beh.vhdl 2> /tmp/tmp_Task$2_User$1
RET=$?
...
######## ELABORATE #######
##########################
ghdl -e --ieee=synopsys fsm_tb 2>/tmp/tmp_Task$2_User$1
RET=$?
...
ghdl -r fsm_tb 2> /tmp/tmp_Task$2_User$1 > /tmp/tmp_Task$2_User$1_msg
