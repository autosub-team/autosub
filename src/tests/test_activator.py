...
#      logger_t.start()
   ...
   def test_loop_code(self):
      ...
      self.add_task(curc, conc, 1, this_time_yesterday, this_time_tomorrow, '/home/testuser/path/to/task/implementation', 'generator.sh', 'tester.sh', '5', 'testoperator@q.q', '1')

      # test case 2: only a logmsg, there is an inactive task, however its starttime has not
      #    come (yet)
      self.add_task(curc, conc, 2, this_time_tomorrow, this_time_nextmonth, '/home/testuser/path/to/task/implementation', 'generator.sh', 'tester.sh', '5', 'testoperator@q.q', '0')
      ...
      self.add_task(curc, conc, 3, this_time_tomorrow, this_time_plus3s, '/home/testuser/path/to/task/implementation', 'generator.sh', 'tester.sh', '5', 'testoperator@q.q', '0')
